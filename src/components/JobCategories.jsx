    ...
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        {categories.map(({ label, icon: Icon, count }) => (
          <div
            key={label}
            className="group bg-white rounded-2xl border border-gray-100 p-6 flex flex-col items-center text-center hover:bg-[#331D2C] hover:border-[#331D2C] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer"
          >
            <div className="w-14 h-14 rounded-xl bg-[#331D2C]/10 group-hover:bg-white/15 flex items-center justify-center mb-4 transition-colors">
              <Icon className="text-[#331D2C] group-hover:text-white text-2xl transition-colors" />
            </div>
